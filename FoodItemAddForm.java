...
public class FoodItemAddForm {
    ...
    public GridPane AddFoodPane(PrimaryGUI primaryGUI) {
        ...
        final double Max_font = 60.0;

        subtitle = new Label("Add food items to the current food list");
        subtitle.setMinHeight(30);
        subtitle.setMinWidth(30);
            ...
            @Override public void handle(ActionEvent event) {
                ...
                try {
                    ...
                    badInputAlert.setContentText(
                        "Invalid input on 'calories' field! Must be a non-negative number!'");
                    badInputAlert.setResizable(true);
                    badInputAlert.showAndWait();
                ...
                try {
                    ...
                    badInputAlert.setTitle("Invalid input!");
                    badInputAlert.setContentText(
                        "Invalid input on 'fat' field! Must be a non-negative number!'");
                    badInputAlert.setResizable(true);
                    badInputAlert.showAndWait();
                ...
                try {
                    ...
                    badInputAlert.setTitle("Invalid input!");
                    badInputAlert.setContentText(
                        "Invalid input on 'carbohydrate' field! Must be a non-negative number!'");
                    badInputAlert.setResizable(true);
                    badInputAlert.showAndWait();
                ...
                try {
                    ...
                    badInputAlert.setTitle("Invalid input!");
                    badInputAlert.setContentText(
                        "Invalid input on 'fiber' field! Must be a non-negative number!'");
                    badInputAlert.setResizable(true);
                    badInputAlert.showAndWait();
                ...
                try {
                    ...
                    badInputAlert.setTitle("Invalid input!");
                    badInputAlert.setContentText(
                        "Invalid input on 'protein' field! Must be a non-negative number!'");
                    badInputAlert.setResizable(true);
                    badInputAlert.showAndWait();
